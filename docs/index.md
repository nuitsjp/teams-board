...
| # | ユースケース | 概要 | 関連アクター |
|--|--|--|--|
| 1 | [参加状況管理](01.参加状況管理/参加状況管理.md) | Microsoft Teams の参加者レポートを取り込み、会議グループの開催実績とメンバーの出席記録を管理・可視化する | 管理者、閲覧者 |
